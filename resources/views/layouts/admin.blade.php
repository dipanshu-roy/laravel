            ...
            <div class="main-header-left">
                ...
                <div class="hor-logo">
                    <a class="main-logo" href="index.html">
                        <img src="{{ asset(config('app.images.logo_url'))}}" class="header-brand-img desktop-logo" alt="logo">
                        <img src="{{ asset(config('app.images.logo_small_url'))}}" class="header-brand-img desktop-logo-dark" alt="logo">
                    </a>
                </div>
            </div>
            <div class="main-header-center">
                <div class="responsive-logo">
                    <a href="index.html"><img src="{{ asset(config('app.images.logo_url'))}}" class="mobile-logo" alt="logo"></a>
                    <a href="index.html"><img src="{{ asset(config('app.images.logo_small_url'))}}" class="mobile-logo-dark" alt="logo"></a>
                </div>
    ...
    <div class="main-footer text-center">
        <div class="container">
            <div class="row row-sm">
                <div class="col-md-12">
                    <span>Copyright © 2022 <a href="javascript:void(0)">{{ config('app.name', 'Dashboard') }}</a>. Designed by <a href="{{ config('app.company_data.url') }}">{{ config('app.company_data.name') }}</a> All rights reserved.</span>
                </div>
            </div>
        </div>
    </div>
